...
public class EntityFactories {
    ...
    public static Ship createShip(WorldState worldState, ViewField field, Coordinate c) {
    ...
    public static Wall createWall(WorldState worldState, ViewField field, Coordinate c) {
        Wall w = new Wall(c);
